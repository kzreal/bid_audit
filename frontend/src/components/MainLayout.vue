    ...
    <div class="w-[30%] bg-white border-r border-gray-200 flex flex-col">
      ...
      <header class="bg-white border-b border-gray-200 px-4 py-3 flex-shrink-0">
        <div class="flex items-center gap-2 min-w-0">
          <div class="w-6 h-6 rounded-vercel-sm bg-vercel-blue flex items-center justify-center flex-shrink-0">
            <svg class="w-3.5 h-3.5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
            </svg>
          </div>
          <h1 class="text-sm font-semibold tracking-tight text-black">投标文件审核系统</h1>
        </div>
      </header>
